...
class SomeProducts3 extends React.Component {
    state = {
      productos : [
        {
        ...
        <section className = "sin-borde"> 
            <div className="container">
                <div className="row ">
                    ...
                    <Card nombre = {this.state.productos[8].nombre}
                    precio = {this.state.productos[8].precio}
                    etiqueta = {this.state.productos[8].etiqueta}
                    imagen = {Portavasos2}
                    id = {this.state.productos[8].id}/> 
                </div>
            </div> 
        </section>    
        </>
